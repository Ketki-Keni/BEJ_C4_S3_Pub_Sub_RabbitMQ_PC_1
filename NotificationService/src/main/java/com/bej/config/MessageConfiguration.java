...
public class MessageConfiguration {
    ...
    private String exchangeName="product-exchange";
    private String queueName="product-queue";
    ...
    {
        return BindingBuilder.bind(registerQueue()).to(directExchange).with("product-routing");
    }
